package io.mobilityCompany.mobile_code_challenge.mainScreen.view

import android.os.Bundle
import android.util.Log
import androidx.appcompat.app.AppCompatActivity
import io.mobilityCompany.mobile_code_challenge.mainScreen.dagger.DaggerMainScreenComponent
import io.mobilityCompany.mobile_code_challenge.mainScreen.dagger.MainScreenComponent
import io.mobilityCompany.mobile_code_challenge.mainScreen.dagger.MainScreenModule
...
class MainScreenActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    injectDependencies()
    hideActionBar()
    setContentView(io.mobilityCompany.mobile_code_challenge.R.layout.activity_main_screen)
